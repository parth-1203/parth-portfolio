      ...
      <div className="flex flex-wrap">
        ...
        >
          <div className="flex justify-center lg:justify-start">
            <p className="my-2 max-w-xl py-6 text-justify text-lg font-fm">{ABOUT_TEXT}</p>
          </div>
          <div className="flex justify-start">
            <a
              onClick={() => {openLink("https://drive.google.com/file/d/1RCWd7m823oO-1hBA2YeNVV0eXbNhf14Y/view")}}
