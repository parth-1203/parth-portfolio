...
const Certificates = () => {
  return (
    <div className="certificates-section py-12">
      ...
      <div className="certificates-list max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 justify-center">
        {CERTIFICATES.map((certificate, index) => (
          <motion.div 
            ...
            <p className="text-gray-400 mb-4"><strong>Position/Issuer:</strong> {certificate.issuer}</p>
            <a 
